...
const jwtHelper_1 = require("./config/jwtHelper");
const course_1 = require("./controllers/course");
const lead_1 = require("./controllers/lead");
const callevent_1 = require("./controllers/callevent");
const leadassignment_1 = require("./controllers/leadassignment");
const fee_1 = require("./controllers/fee");
const student_1 = require("./controllers/student");
const feeflow_1 = require("./controllers/feeflow");
const boardoruniversity_1 = require("./controllers/boardoruniversity");
const collectionflow_1 = require("./controllers/collectionflow");
const test_1 = require("./controllers/test");
const invoice_1 = require("./controllers/invoice");
const upload = require('./middlewares/uploads');
const coursename_1 = require("./controllers/coursename");
const branch_1 = require("./controllers/branch");
const coursesubject_1 = require("./controllers/coursesubject");
const studymaterials_1 = require("./controllers/studymaterials");
const center_1 = require("./controllers/center");
const booklibrary_1 = require("./controllers/booklibrary");
// const upload= require('./middlewares/testupload');
function setRoutes(app) {
    const router = express.Router();
    const userCtrl = new user_1.default();
    const courseCtrl = new course_1.default();
    const feeflowCrl = new feeflow_1.default();
    const leadCtrl = new lead_1.default();
    const calleventCtrl = new callevent_1.default();
    const leadAssignmentCtrl = new leadassignment_1.default();
    const studentCtrl = new student_1.default();
    const boardOrUniveristyCtrl = new boardoruniversity_1.default();
    const collectionflowCtrl = new collectionflow_1.default();
    const jwtHelper = new jwtHelper_1.default();
    const feeCtrl = new fee_1.default();
    const testCtrl = new test_1.default();
    const invoiceCtrl = new invoice_1.default();
    const coursenameCtrl = new coursename_1.default();
    const branchCtrl = new branch_1.default();
    const coursesubjectCtrl = new coursesubject_1.default();
    const studymaterialCtrl = new studymaterials_1.default();
    const centerCtrl = new center_1.default();
    const booklibraryCtrl = new booklibrary_1.default();
    // Users
